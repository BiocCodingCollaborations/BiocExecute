---
title: "BiocExecute: make package functions/workflows executable in the CLI."
output:
...
If you have any questions, or want to contribute to this package, don't
hesitate to create an issue in the [GitHub
repo](https://github.com/BiocCodingCollaborations/EuroBioc2026_Hackathon#commandline-executables-for-bioconductor-functions-and-scripts).
